...
var ComboSearch = function (_React$Component) {
    ...
    function ComboSearch(props) {
        ...
        _this.changeSecondLevelCriteria = _this.changeSecondLevelCriteria.bind(_this);
    ...
    _createClass(ComboSearch, [{
        ...
        key: 'changeSecondLevelCriteria',
        value: function changeSecondLevelCriteria(value, text) {
        ...
        value: function render() {
            ...
            var isSecondLevelSelectNeeded = false;
            var secondLevelSelectOptions = null;

            if (this.props.secondLevelSelectData) {
                for (var property in this.props.secondLevelSelectData) {
                    if (property === this.state.criteria) {
                        if (Array.isArray(this.props.secondLevelSelectData[property])) isSecondLevelSelectNeeded = true;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    ) : isSecondLevelSelectNeeded ? _react2.default.createElement(
                        'div',
...
ComboSearch.propTypes = {
    ...
    secondLevelSelectData: _propTypes2.default.object,
